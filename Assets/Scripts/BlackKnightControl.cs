...
public class BlackKnightControl : MonoBehaviour {
    ...
    void Update () {
        ...
        if ( horizontal != 0 ) {
            ...
            if ( horizontal < 0 ) {
                ...
                //newPosition = this.transform.position + new Vector2( -dis, 0 );
            ...
            //this.transform.position = Vector2.SmoothDamp( this.transform.position, newPosition, ref velocity, speed );
